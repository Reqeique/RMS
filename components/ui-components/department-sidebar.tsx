  ...
  const notifications = [
    {
      ...
      description: "A new feedback has been submitted for your department",
      time: "5 minutes ago",
      unread: true,
      type: "feedback",
    },
    {
      ...
      description: "Clean rooms 301-310 has been assigned to your department",
      time: "30 minutes ago",
      unread: true,
      type: "issue",
    },
    {
      ...
      description: "Your team completed the cleaning request for rooms 401-410",
      time: "2 hours ago",
      unread: false,
      type: "order",
    },
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-1">
                  <NavItem href="/department" icon={Home}>
                    Department Overview
                  </NavItem>
                  <NavItem href="/department/analytics" icon={BarChart2}>
              ...
              <div>
                ...
                <div className="space-y-1">
                  <NavItem href="/department/feedback" icon={MessageSquare}>
                    Department Feedback
                  </NavItem>
                  <NavItem href="/department/performance" icon={ThumbsUp}>
              ...
              <div>
                ...
                <div className="space-y-1">
                  <NavItem href="/department/orders" icon={ArrowUpRight}>
                    Department Orders
                  </NavItem>
                  <NavItem href="/department/issues" icon={AlertTriangle}>
                    Issues & Tasks
                  </NavItem>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  <NavItem href="/department/staff" icon={Users2}>
                    Staff Management
                  </NavItem>
                </div>
              </div>
              ...
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="w-full justify-start px-2">
                  ...
                  <div className="flex-1 text-left">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">Housekeeping</p>
                  </div>
